...
#define nstates6	209	/* never_0 */
#define minseq6	306
#define maxseq6	513
#define endstate6	208

#define nstates5	13	/* :init: */
#define minseq5	294
#define maxseq5	305
#define endstate5	12

#define nstates4	38	/* transport */
#define minseq4	257
#define maxseq4	293
#define endstate4	37

#define nstates3	85	/* GIOPAgent */
#define minseq3	173
#define maxseq3	256
#define endstate3	84

#define nstates2	50	/* Server */
#define minseq2	124
#define maxseq2	172
#define endstate2	49

#define nstates1	89	/* GIOPClient */
#define minseq1	36
#define maxseq1	123
#define endstate1	88

#define nstates0	37	/* User */
#define minseq0	0
#define maxseq0	35
#define endstate0	36
...
struct ObjRef { /* user defined type */
	uchar objKey;
	uchar port;
};
struct MsgHeader { /* user defined type */
	uchar request_id;
	uchar object_key;
	uchar reply_status;
	uchar forward_port;
...
struct GIOPMsg { /* user defined type */
	struct MsgHeader mhdr;
};
typedef struct P6 { /* never_0 */
...
#define Ptransport	((P4 *)this)
typedef struct P4 { /* transport */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define PGIOPAgent	((P3 *)this)
typedef struct P3 { /* GIOPAgent */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
	unsigned _priority : 8; /* 0..255 */
#endif
	unsigned connState : 1;
	uchar port;
	uchar numOutstandingReqs;
	uchar reqId;
	uchar objKey;
	uchar clPort;
	uchar requested[4];
...
#define Air2	(sizeof(P2) - Offsetof(P2, numMigrations) - 1*sizeof(uchar))

#define PGIOPClient	((P1 *)this)
typedef struct P1 { /* GIOPClient */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
...
#endif
	uchar gPublished[2];
	uchar user6Processed;
	uchar user7Processed;
	uchar numRequestsRcvd[3];
	uchar numRepliesSent[3];
	uchar Pid[10];
	uchar usedReqId[4];
	uchar toUser;
	uchar toClientL;
	...
	uchar toAgentU[3];
	uchar toAgentL[3];
	uchar toTransportU[3];
	uchar toTransportL[3];
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar srequested[4];
/* hidden variable: */	uchar srequest_reqId;
/* hidden variable: */	uchar sreply_reqId;
/* hidden variable: */	uchar request_reqId;
/* hidden variable: */	uchar reply_reqId;
...
int Q_has(int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int);
