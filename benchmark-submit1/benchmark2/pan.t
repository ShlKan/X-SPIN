...
{	Trans *T;
  ...
  SI = (int *) emalloc(58*sizeof(int));
	...
	T = T->nxt	= settr(257,0,1,0,0,"DO", 0, 2, 0);
		...
		/* ./v7.never:15 */
	SI[1] = 0;
	trans[6][1]	= settr(253,0,25,3,0,"(!((usedReqId[0]!=0)))", 1, 2, 0);
		tr_2_src(3, "./v7.never", 16);
	SI[2] = 0;
	...
	T = T->nxt	= settr(265,0,8,0,0,"DO", 0, 2, 0);
		...
		/* ./v7.never:20 */
	SI[8] = 1;
	trans[6][8]	= settr(260,0,13,4,0,"(!((usedReqId[0]!=0)))", 1, 2, 0);
		tr_2_src(4, "./v7.never", 21);
	SI[9] = 1;
	...
	T->nxt	= settr(264,2,10,0,0,"ATOMIC", 1, 2, 0);
		/* ./v7.never:22 */
	trans[6][10]	= settr(262,2,11,5,0,"((!((usedReqId[0]!=0))&&((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0))))", 1, 2, 0);
		tr_2_src(5, "./v7.never", 22);
	trans[6][11]	= settr(263,0,13,6,0,"assert(!((!((usedReqId[0]!=0))&&((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0)))))", 1, 2, 0);
		tr_2_src(6, "./v7.never", 22);
	SI[15] = 0;
	...
	T = T->nxt	= settr(277,0,21,0,0,"DO", 0, 2, 0);
		...
		/* ./v7.never:25 */
	SI[16] = 1;
	trans[6][16]	= settr(268,0,13,7,0,"((!((usedReqId[0]!=0))&&((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0))))", 1, 2, 0);
		tr_2_src(7, "./v7.never", 26);
	SI[17] = 1;
	...
	T->nxt	= settr(272,2,18,0,0,"ATOMIC", 1, 2, 0);
		/* ./v7.never:27 */
	trans[6][18]	= settr(270,2,19,8,0,"((!((usedReqId[0]!=0))&&((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0))))", 1, 2, 0);
		tr_2_src(8, "./v7.never", 27);
	trans[6][19]	= settr(271,0,25,9,0,"assert(!((!((usedReqId[0]!=0))&&((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0)))))", 1, 2, 0);
		tr_2_src(9, "./v7.never", 27);
	SI[21] = 1;
	trans[6][21]	= settr(273,0,45,10,0,"(!((usedReqId[0]!=0)))", 1, 2, 0);
		tr_2_src(10, "./v7.never", 28);
	SI[22] = 1;
	trans[6][22]	= settr(274,0,45,1,0,"goto T0_S9", 0, 2, 0);
	SI[23] = 1;
	trans[6][23]	= settr(275,0,53,11,0,"((!((usedReqId[0]!=0))&&((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0))))", 1, 2, 0);
		tr_2_src(11, "./v7.never", 29);
	SI[24] = 1;
	...
	T->nxt	= settr(282,2,28,0,0,"ATOMIC", 1, 2, 0);
		/* ./v7.never:33 */
	trans[6][28]	= settr(280,2,29,12,0,"(((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0)))", 1, 2, 0);
		tr_2_src(12, "./v7.never", 33);
	trans[6][29]	= settr(281,0,33,13,0,"assert(!(((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0))))", 1, 2, 0);
		tr_2_src(13, "./v7.never", 33);
	SI[31] = 1;
	...
	T = T->nxt	= settr(297,0,41,0,0,"DO", 0, 2, 0);
		...
		/* ./v7.never:37 */
	SI[36] = 1;
	trans[6][36]	= settr(288,0,13,14,0,"((!((usedReqId[0]!=0))&&((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0))))", 1, 2, 0);
		tr_2_src(14, "./v7.never", 38);
	SI[37] = 1;
	...
	T->nxt	= settr(292,2,38,0,0,"ATOMIC", 1, 2, 0);
		/* ./v7.never:39 */
	trans[6][38]	= settr(290,2,39,15,0,"((!((usedReqId[0]!=0))&&((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0))))", 1, 2, 0);
		tr_2_src(15, "./v7.never", 39);
	trans[6][39]	= settr(291,0,45,16,0,"assert(!((!((usedReqId[0]!=0))&&((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0)))))", 1, 2, 0);
		tr_2_src(16, "./v7.never", 39);
	SI[41] = 1;
	trans[6][41]	= settr(293,0,45,17,0,"(!((usedReqId[0]!=0)))", 1, 2, 0);
		tr_2_src(17, "./v7.never", 40);
	SI[42] = 1;
	trans[6][42]	= settr(294,0,45,1,0,"goto T0_S9", 0, 2, 0);
	SI[43] = 1;
	trans[6][43]	= settr(295,0,33,18,0,"((!((usedReqId[0]!=0))&&((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0))))", 1, 2, 0);
		tr_2_src(18, "./v7.never", 41);
	SI[44] = 1;
	...
	T->nxt	= settr(302,2,48,0,0,"ATOMIC", 1, 2, 0);
		/* ./v7.never:45 */
	trans[6][48]	= settr(300,2,49,19,0,"(((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0)))", 1, 2, 0);
		tr_2_src(19, "./v7.never", 45);
	trans[6][49]	= settr(301,0,53,20,0,"assert(!(((GIOPClient[Pid[3]]._p==ReplyRecvd)&&(reply_reqId==0))))", 1, 2, 0);
		tr_2_src(20, "./v7.never", 45);
	SI[51] = 1;
...
for(i=0;i<58;i++)	 sicnt[i]=0;xspinflag = 1;numberofbastates = 58;
	...
	trans[4][1]	= settr(204,0,2,33,33,"uin?msgType,dstport,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 521, 0);
		tr_2_src(33, "giop3.nomig.pr", 651);
	trans[4][2]	= settr(205,0,7,34,34,"toTransportL[dstport]!msgType,connId[dstport],port,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 20, 0);
		tr_2_src(34, "giop3.nomig.pr", 659);
	...
	trans[4][9]	= settr(212,0,10,38,0,"(savedmsg?[msgType,rcvConnId,srcport,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag])", 1, 2, 0);
		tr_2_src(38, "giop3.nomig.pr", 671);
	trans[4][10]	= settr(213,0,27,39,39,"savedmsg?msgType,rcvConnId,srcport,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 523, 0);
		tr_2_src(39, "giop3.nomig.pr", 672);
	...
	trans[4][16]	= settr(219,0,27,40,40,"toTransportL[port]?msgType,rcvConnId,srcport,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 520, 0);
		tr_2_src(40, "giop3.nomig.pr", 678);
	...
	trans[4][17]	= settr(220,0,23,41,0,"((rcvConnId==connId[srcport]))", 0, 2, 0);
		tr_2_src(41, "giop3.nomig.pr", 689);
	...
	trans[4][20]	= settr(223,0,21,44,44,"savedmsg!msgType,rcvConnId,srcport,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 23, 0);
		tr_2_src(44, "giop3.nomig.pr", 700);
	trans[4][21]	= settr(224,0,2,45,45,"uin?msgType,dstport,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 521, 0);
		tr_2_src(45, "giop3.nomig.pr", 701);
	...
	trans[3][1]	= settr(129,0,4,52,52,"uin?SRegister,objKey,_,_", 1, 515, 0);
		tr_2_src(52, "giop3.nomig.pr", 450);
		tr_2_src(53, "giop3.nomig.pr", 452);
/*->*/	trans[3][4]	= settr(132,32,72,53,53,"D_STEP452", 1, 2, 0);
	trans[3][5]	= settr(133,0,6,54,54,"uin?SMigrateReq,objKey,clPort,_", 1, 515, 0);
		tr_2_src(54, "giop3.nomig.pr", 462);
	trans[3][6]	= settr(134,0,72,55,55,"registered[objKey] = clPort", 0, 2, 0);
		tr_2_src(55, "giop3.nomig.pr", 467);
	trans[3][7]	= settr(135,0,10,56,56,"lin?Request,clPort,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 517, 0);
		tr_2_src(56, "giop3.nomig.pr", 471);
		tr_2_src(57, "giop3.nomig.pr", 476);
/*->*/	trans[3][10]	= settr(138,32,34,57,57,"D_STEP476", 0, 2, 0);
	...
	trans[3][11]	= settr(139,0,13,58,0,"((registered[objKey]==port))", 0, 2, 0);
		tr_2_src(58, "giop3.nomig.pr", 484);
		tr_2_src(59, "giop3.nomig.pr", 489);
/*->*/	trans[3][13]	= settr(141,32,14,59,59,"D_STEP489", 0, 2, 0);
	trans[3][14]	= settr(142,0,17,60,60,"uout!SRequest,objKey,reqId,clPort,msg.mhdr.tag", 1, 16, 0);
		tr_2_src(60, "giop3.nomig.pr", 495);
		tr_2_src(61, "giop3.nomig.pr", 498);
/*->*/	trans[3][17]	= settr(145,32,72,61,61,"D_STEP498", 0, 2, 0);
	trans[3][35]	= settr(163,0,72,1,0,".(goto)", 0, 2, 0);
	trans[3][18]	= settr(146,0,30,62,0,"((registered[objKey]!=port))", 0, 2, 0);
		tr_2_src(62, "giop3.nomig.pr", 506);
	...
	trans[3][19]	= settr(147,0,23,63,0,"((registered[objKey]==255))", 0, 2, 0);
		tr_2_src(63, "giop3.nomig.pr", 509);
		tr_2_src(64, "giop3.nomig.pr", 511);
/*->*/	trans[3][23]	= settr(151,32,32,64,64,"D_STEP511", 0, 2, 0);
	trans[3][31]	= settr(159,0,32,1,0,".(goto)", 0, 2, 0);
	trans[3][24]	= settr(152,0,29,2,0,"else", 0, 2, 0);
		tr_2_src(65, "giop3.nomig.pr", 520);
/*->*/	trans[3][29]	= settr(157,32,32,65,65,"D_STEP520", 0, 2, 0);
	trans[3][32]	= settr(160,0,33,66,66,"lout!Reply,clPort,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 18, 0);
		tr_2_src(66, "giop3.nomig.pr", 529);
	trans[3][33]	= settr(161,0,72,1,0,"(1)", 0, 2, 0);
	trans[3][36]	= settr(164,0,37,67,67,"uin?SReply,objKey,reqId,clPort", 1, 515, 0);
		tr_2_src(67, "giop3.nomig.pr", 535);
	trans[3][37]	= settr(165,0,51,68,0,"assert((requested[reqId]!=0))", 0, 2, 0);
		tr_2_src(68, "giop3.nomig.pr", 541);
	...
	trans[3][38]	= settr(166,0,41,69,0,"((requested[reqId]==2))", 0, 2, 0);
		tr_2_src(69, "giop3.nomig.pr", 547);
		tr_2_src(70, "giop3.nomig.pr", 550);
/*->*/	trans[3][41]	= settr(169,32,62,70,70,"D_STEP550", 0, 2, 0);
	trans[3][52]	= settr(180,0,62,1,0,".(goto)", 0, 2, 0);
	trans[3][42]	= settr(170,0,46,71,0,"((requested[reqId]==1))", 0, 2, 0);
		tr_2_src(71, "giop3.nomig.pr", 557);
		tr_2_src(72, "giop3.nomig.pr", 558);
/*->*/	trans[3][46]	= settr(174,32,47,72,72,"D_STEP558", 0, 2, 0);
	trans[3][47]	= settr(175,0,50,73,73,"lout!Reply,clPort,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 18, 0);
		tr_2_src(73, "giop3.nomig.pr", 564);
		tr_2_src(74, "giop3.nomig.pr", 566);
/*->*/	trans[3][50]	= settr(178,32,62,74,74,"D_STEP566", 0, 2, 0);
	...
	trans[3][53]	= settr(181,0,59,75,0,"((numOutstandingReqs==0))", 0, 2, 0);
		tr_2_src(75, "giop3.nomig.pr", 579);
	...
	trans[3][54]	= settr(182,0,55,76,76,"((connState==1))", 0, 2, 0);
		tr_2_src(76, "giop3.nomig.pr", 581);
...
/*->*/	trans[3][57]	= settr(185,32,72,78,78,"D_STEP586", 0, 2, 0);
	...
	trans[2][1]	= settr(122,0,4,88,88,"toAgentU[port]!SRegister,objKey,port,0", 1, 13, 0);
		tr_2_src(88, "giop3.nomig.pr", 421);
	...
	trans[1][1]	= settr(36,0,4,92,92,"uin?URequest,tag,objref.objKey,objref.port", 1, 508, 0);
		tr_2_src(92, "giop3.nomig.pr", 227);
		tr_2_src(93, "giop3.nomig.pr", 233);
/*->*/	trans[1][4]	= settr(39,32,10,93,93,"D_STEP233", 0, 2, 0);
	...
	trans[1][13]	= settr(48,0,20,98,98,"usedReqId[reqId] = 1", 1, 2, 0);
		tr_2_src(98, "giop3.nomig.pr", 249);
		tr_2_src(99, "giop3.nomig.pr", 250);
/*->*/	trans[1][20]	= settr(55,32,21,99,99,"D_STEP250", 0, 2, 0);
	trans[1][21]	= settr(56,0,27,100,100,"lout!Request,svrPort,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 11, 0);
		tr_2_src(100, "giop3.nomig.pr", 264);
	...
	trans[1][29]	= settr(64,0,32,104,104,"lin?Reply,svrPort,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 510, 0);
		tr_2_src(104, "giop3.nomig.pr", 284);
		tr_2_src(105, "giop3.nomig.pr", 289);
/*->*/	trans[1][32]	= settr(67,32,53,105,105,"D_STEP289", 1, 2, 0);
	T = trans[1][53] = settr(88,0,0,0,0,"IF", 1, 2, 0);
		/* giop3.nomig.pr:296 */
	...
	trans[1][33]	= settr(68,0,45,106,0,"((usedReqId[reqId]==1))", 1, 2, 0);
		tr_2_src(106, "giop3.nomig.pr", 297);
	...
	trans[1][34]	= settr(69,0,36,107,0,"((msg.mhdr.reply_status==4))", 0, 2, 0);
		tr_2_src(107, "giop3.nomig.pr", 301);
		tr_2_src(108, "giop3.nomig.pr", 306);
/*->*/	trans[1][36]	= settr(71,32,37,108,108,"D_STEP306", 0, 2, 0);
	trans[1][37]	= settr(72,0,83,109,109,"lout!Request,objRefs[reqId].port,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 11, 0);
		tr_2_src(109, "giop3.nomig.pr", 310);
	...
	trans[1][39]	= settr(74,0,44,110,110,"uout!UReply,tags[reqId],msg.mhdr.reply_status", 1, 9, 0);
		tr_2_src(110, "giop3.nomig.pr", 315);
		tr_2_src(111, "giop3.nomig.pr", 318);
/*->*/	trans[1][44]	= settr(79,32,83,111,111,"D_STEP318", 1, 2, 0);
	trans[1][54]	= settr(89,0,83,1,0,".(goto)", 0, 2, 0);
	trans[1][47]	= settr(82,0,52,112,0,"((usedReqId[reqId]==2))", 1, 2, 0);
		tr_2_src(112, "giop3.nomig.pr", 328);
		tr_2_src(113, "giop3.nomig.pr", 330);
/*->*/	trans[1][52]	= settr(87,32,83,113,113,"D_STEP330", 1, 2, 0);
	trans[1][55]	= settr(90,0,56,114,114,"lin?CloseConnection,svrPort,msg.mhdr.request_id,msg.mhdr.object_key,msg.mhdr.reply_status,msg.mhdr.forward_port,msg.mhdr.tag", 1, 510, 0);
		tr_2_src(114, "giop3.nomig.pr", 339);
	trans[1][56]	= settr(91,0,80,115,115,"reqId = 0", 0, 2, 0);
		tr_2_src(115, "giop3.nomig.pr", 348);
	...
	trans[1][60]	= settr(95,0,74,118,0,"((objRefs[reqId].port==svrPort))", 0, 2, 0);
		tr_2_src(118, "giop3.nomig.pr", 355);
	...
	trans[1][61]	= settr(96,0,65,119,0,"((usedReqId[reqId]==1))", 1, 2, 0);
		tr_2_src(119, "giop3.nomig.pr", 358);
		tr_2_src(120, "giop3.nomig.pr", 365);
/*->*/	trans[1][65]	= settr(100,32,66,120,120,"D_STEP365", 0, 2, 0);
...
/*->*/	trans[1][72]	= settr(107,32,79,123,123,"D_STEP377", 1, 2, 0);
	...
	trans[1][86]	= settr(121,0,0,127,127,"-end-", 0, 3500, 0);
		tr_2_src(127, "giop3.nomig.pr", 397);
	...
	trans[0][1]	= settr(0,2,7,128,128,"i = 0", 1, 2, 0);
		tr_2_src(128, "giop3.nomig.pr", 147);
