...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* CLAIM never_0 */
	case 3: // STATE 1 - ./v6a.never:14 - [(((GIOPAgent[Pid[4]]._p==SRequestSent)&&(srequest_reqId==0)))] (0:0:0 - 0)
...
#endif
		reached[6][1] = 1;
		if (!(((((int)((P3 *)Pptr(BASE+((int)now.Pid[4])))->_p)==17)&&(((int)now.srequest_reqId)==0))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 8 - ./v6a.never:19 - [(!(((GIOPAgent[Pid[4]]._p==SReplyReceived)&&(sreply_reqId==0))))] (0:0:0 - 0)
...
#endif
		reached[6][8] = 1;
		if (!( !(((((int)((P3 *)Pptr(BASE+((int)now.Pid[4])))->_p)==51)&&(((int)now.sreply_reqId)==0)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 5: // STATE 13 - ./v6a.never:21 - [-end-] (0:0:0 - 0)
