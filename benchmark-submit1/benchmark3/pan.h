...
#define PanSource	"giop3.nomig.pr"
...
#define nstates3	76	/* GIOPAgent */
#define minseq3	129
#define maxseq3	203
#define endstate3	75

#define nstates2	8	/* Server */
#define minseq2	122
#define maxseq2	128
#define endstate2	7

#define nstates1	87	/* GIOPClient */
#define minseq1	36
#define maxseq1	121
#define endstate1	86
...
#define Air2	(sizeof(P2) - Offsetof(P2, tag) - 1*sizeof(uchar))
...
/* hidden variable: */	uchar user6Processed;
/* hidden variable: */	uchar user7Processed;
...
/* hidden variable: */	uchar numRequestsRcvd[3];
/* hidden variable: */	uchar numRepliesSent[3];
/* hidden variable: */	uchar Pid[10];
